...
if ( class_exists( 'AG_direct_errors' ) ) {
	return;
}


class AG_direct_errors {

    public static function get_epdq_direct_status_code($code){
		if( $code == '' )
			return;
		$codes =  array(
	...
	public static function get_epdq_direct_ncerror($code) {
		if ($code == '')
			return;
		...
		$ncerorr_list=array(
			...
			50001111=>'Please check your card details and try again.',
